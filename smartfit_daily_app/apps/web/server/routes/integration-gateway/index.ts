...
router.post('/integrations/smart-scale/connect', async (req, res) => {
...
router.delete('/integrations/smart-scale', async (req, res) => {
  await db.doc(`users/${req.userId}`).set(
 ...
 */
router.post('/integrations/smart-scale/sync', async (req, res) => {
...
router.post('/integrations/wearable/connect', async (req, res) => {
  await db.doc(`users/${req.userId}`).set(
...
router.delete('/integrations/wearable', async (req, res) => {
  await db.doc(`users/${req.userId}`).set(
 ...
 * (not an error).
 */
router.post('/integrations/wearable/readings', async (req, res) => {
