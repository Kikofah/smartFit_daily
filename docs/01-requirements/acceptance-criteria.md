...
#### AC-ONB-0-08 — เข้าสู่ระบบด้วย credential ที่ไม่ถูกต้อง เห็นข้อความเดียวกันทั้งรหัสผ่านผิดและอีเมลที่ไม่มีบัญชี (เพิ่ม 2026-09-26, REQ-15)
- **Given**: ผู้ใช้อยู่ที่หน้าเข้าสู่ระบบบนเว็บแอป
- **When**: ผู้ใช้กรอกอีเมลและรหัสผ่านครบ แล้วกด "เข้าสู่ระบบ" โดยรหัสผ่านไม่ถูกต้อง **หรือ** อีเมลนั้นไม่มีบัญชี
  ในระบบ
- **Then**: ผู้ใช้อยู่ที่หน้าเข้าสู่ระบบต่อ (ไม่มี session ถูกสร้าง) และเห็นข้อความ "อีเมลหรือรหัสผ่านไม่ถูกต้อง"
  **ข้อความเดียวกันทั้งสองกรณี** — ไม่บอกว่าผิดที่ช่องไหน เพื่อไม่ให้เดาได้ว่าอีเมลไหนมีบัญชี แล้วลองใหม่ได้ทันที
- Prototype: [00-auth-login.html](../02-design/01-prototypes/v1/00-auth-login.html) (ข้อความเหนือปุ่ม
  "เข้าสู่ระบบ" — เพิ่ม 2026-09-26 บัญชีทดลองที่ผ่านคือ `newuser@example.com` / `Passw0rd!23` ค่าอื่นได้สถานะนี้)
- ต้นทาง: [Onboarding spec § ข้อสมมติฐาน/การตัดสินใจที่ยืนยันแล้ว](01-spec/20260823-01-onboarding-personalization.md#ข้อสมมติฐานการตัดสินใจที่ยืนยันแล้ว) ("เข้าสู่ระบบไม่สำเร็จ" ข้อ 1–2),
  [user-journeys.md § ONB-0](../02-design/01-prototypes/user-journeys.md#onb-0--สมัครสมาชิก--เข้าสู่ระบบ--ลืมรหัสผ่าน--ออกจากระบบ-req-14-req-15-req-16-req-17) Step 10 และ Alt/Edge Case

#### AC-ONB-0-09 — ไม่กรอกอีเมลหรือรหัสผ่าน ระบบเตือนก่อนส่ง (เพิ่ม 2026-09-26, REQ-15)
- **Given**: ผู้ใช้อยู่ที่หน้าเข้าสู่ระบบบนเว็บแอป
- **When**: ผู้ใช้กด "เข้าสู่ระบบ" โดยเว้นช่องอีเมล และ/หรือ ช่องรหัสผ่านว่างไว้
- **Then**: ระบบแสดง "กรุณากรอกอีเมล" ใต้ช่องอีเมลที่ว่าง และ/หรือ "กรุณากรอกรหัสผ่าน" ใต้ช่องรหัสผ่านที่ว่าง
  โดยไม่ส่งไปตรวจสอบกับระบบยืนยันตัวตนเลย และผู้ใช้อยู่ที่หน้าเข้าสู่ระบบต่อ
- Prototype: [00-auth-login.html](../02-design/01-prototypes/v1/00-auth-login.html) (ข้อความ error ของช่องที่ว่าง
  มีอยู่แล้วใน prototype v1)
- ต้นทาง: [Onboarding spec § ข้อสมมติฐาน/การตัดสินใจที่ยืนยันแล้ว](01-spec/20260823-01-onboarding-personalization.md#ข้อสมมติฐานการตัดสินใจที่ยืนยันแล้ว) ("เข้าสู่ระบบไม่สำเร็จ" ข้อ 4),
  [user-journeys.md § ONB-0](../02-design/01-prototypes/user-journeys.md#onb-0--สมัครสมาชิก--เข้าสู่ระบบ--ลืมรหัสผ่าน--ออกจากระบบ-req-14-req-15-req-16-req-17) Alt/Edge Case

#### AC-ONB-0-10 — เข้าสู่ระบบไม่สำเร็จด้วยสาเหตุอื่น เห็นข้อความภาษาไทย ไม่เห็นข้อความทางเทคนิค (เพิ่ม 2026-09-26, REQ-15)
- **Given**: ผู้ใช้อยู่ที่หน้าเข้าสู่ระบบบนเว็บแอป
- **When**: การเข้าสู่ระบบ (ด้วยอีเมลหรือ Google) ล้มเหลวด้วยสาเหตุอื่นที่ไม่ใช่ credential ผิด — รูปแบบอีเมลผิด,
  บัญชีถูกระงับ, ลองผิดหลายครั้งเกินไป, เชื่อมต่ออินเทอร์เน็ตไม่ได้, ปิดหรือบล็อกหน้าต่าง Google, หรือสาเหตุที่
  ระบบไม่รู้จัก
- **Then**: ผู้ใช้อยู่ที่หน้าเข้าสู่ระบบต่อ และเห็นข้อความภาษาไทยเฉพาะของสาเหตุนั้น (สาเหตุที่ไม่รู้จักเห็น
  "เข้าสู่ระบบไม่สำเร็จ กรุณาลองใหม่อีกครั้ง") — **ไม่มีข้อความทางเทคนิคดิบ** ของระบบยืนยันตัวตน (เช่น
  `Firebase: Error (auth/...)`) ปรากฏบนหน้าจอเลย
- Prototype: [00-auth-login.html](../02-design/01-prototypes/v1/00-auth-login.html) (จำลองได้เฉพาะรูปแบบ
  อีเมลผิดและออฟไลน์ — บัญชีถูกระงับ/ลองผิดหลายครั้ง/pop-up Google ไม่มีใน prototype)
- ต้นทาง: [Onboarding spec § ข้อสมมติฐาน/การตัดสินใจที่ยืนยันแล้ว](01-spec/20260823-01-onboarding-personalization.md#ข้อสมมติฐานการตัดสินใจที่ยืนยันแล้ว) ("เข้าสู่ระบบไม่สำเร็จ" ข้อ 3),
  [user-journeys.md § ONB-0](../02-design/01-prototypes/user-journeys.md#onb-0--สมัครสมาชิก--เข้าสู่ระบบ--ลืมรหัสผ่าน--ออกจากระบบ-req-14-req-15-req-16-req-17) Alt/Edge Case
...
- **Given**: ผู้ใช้มีเป้าหมายน้ำหนัก (จาก ONB-3) และมีประวัติ log แคลอรี่จริงสะสม (PLN-3) **อย่างน้อย 7 วัน**
  โดยมีอัตราขาดดุล/เกินดุลเฉลี่ยที่ไม่เป็น 0 และสอดคล้องกับทิศทางเป้าหมาย
...
- ต้นทาง decision (จำนวนวันขั้นต่ำ = 7, ยืนยัน 2026-09-26): [Smart Integrations spec § ข้อสมมติฐาน/การตัดสินใจที่ยืนยันแล้ว](01-spec/20260823-04-smart-integrations.md#ข้อสมมติฐานการตัดสินใจที่ยืนยันแล้ว)

#### AC-INT-1-02 — ประวัติ log น้อยกว่า 7 วัน แสดง empty state ให้สะสมข้อมูลเพิ่ม (REQ-11)
- **Given**: ผู้ใช้มีเป้าหมายน้ำหนัก (จาก ONB-3) แต่เพิ่งเริ่มใช้แอปและมีประวัติ log แคลอรี่จริงสะสม
  **น้อยกว่า 7 วัน**
- **When**: ผู้ใช้เปิดหน้า Progress/Insights
- **Then**: ระบบแสดง empty state "ประวัติยังไม่พอสำหรับพยากรณ์" แจ้งผู้ใช้ว่าต้องสะสมข้อมูลเพิ่ม แทนที่จะแสดง
  วันที่คาดการณ์ — ไม่แสดงวันที่ปลอม/ประมาณการใด ๆ
- Prototype: [10-progress-insights.html](../02-design/01-prototypes/v1/10-progress-insights.html)
- ต้นทาง decision (ยืนยัน 2026-09-26): [Smart Integrations spec § ข้อสมมติฐาน/การตัดสินใจที่ยืนยันแล้ว](01-spec/20260823-04-smart-integrations.md#ข้อสมมติฐานการตัดสินใจที่ยืนยันแล้ว)
...
#### AC-INT-1-08 — ขอบเขต: มี log 6 วัน (น้อยกว่าเกณฑ์ 1 วัน) ยังแสดง empty state (เพิ่ม 2026-09-26, REQ-11)
- **Given**: ผู้ใช้มีเป้าหมายน้ำหนัก (จาก ONB-3) และมีประวัติ log แคลอรี่จริงสะสม **6 วันพอดี** (ต่ำกว่าเกณฑ์
  ขั้นต่ำ 7 วันเพียง 1 วัน) โดยอัตราขาดดุลเฉลี่ยไม่เป็น 0 และสอดคล้องกับทิศทางเป้าหมาย
- **When**: ผู้ใช้เปิดหน้า Progress/Insights
- **Then**: ระบบยังแสดง empty state "ประวัติยังไม่พอสำหรับพยากรณ์" เหมือน AC-INT-1-02 — ไม่แสดงวันที่คาดการณ์
  แม้อัตราขาดดุลเฉลี่ยจะคำนวณได้แล้วก็ตาม
- Prototype: [10-progress-insights.html](../02-design/01-prototypes/v1/10-progress-insights.html)
- ต้นทาง: [user-journeys.md § INT-1 Alt/Edge Cases](../02-design/01-prototypes/user-journeys.md#int-1--พยากรณ์วันถึงเป้าหมายน้ำหนัก-req-11)
  ("มีประวัติ log น้อยกว่า 7 วัน → empty state") และ [Smart Integrations spec § ข้อสมมติฐาน/การตัดสินใจที่ยืนยันแล้ว](01-spec/20260823-04-smart-integrations.md#ข้อสมมติฐานการตัดสินใจที่ยืนยันแล้ว)

#### AC-INT-1-09 — ขอบเขต: มี log ครบ 7 วันพอดี แสดงวันที่คาดการณ์ได้ (เพิ่ม 2026-09-26, REQ-11)
- **Given**: ผู้ใช้มีเป้าหมายน้ำหนัก (จาก ONB-3) และมีประวัติ log แคลอรี่จริงสะสม **7 วันพอดี** (เท่ากับเกณฑ์
  ขั้นต่ำ) โดยอัตราขาดดุลเฉลี่ยไม่เป็น 0 และสอดคล้องกับทิศทางเป้าหมาย
- **When**: ผู้ใช้เปิดหน้า Progress/Insights
- **Then**: ระบบแสดงวันที่คาดว่าจะถึงน้ำหนักเป้าหมาย (คำนวณเหมือน AC-INT-1-01) — เกณฑ์เป็นแบบ "อย่างน้อย 7
  วัน" (≥ 7) ไม่ใช่ "มากกว่า 7 วัน"
- Prototype: [10-progress-insights.html](../02-design/01-prototypes/v1/10-progress-insights.html)
- ต้นทาง: [user-journeys.md § INT-1 Alt/Edge Cases](../02-design/01-prototypes/user-journeys.md#int-1--พยากรณ์วันถึงเป้าหมายน้ำหนัก-req-11)
  ("มีครบ 7 วันพอดี → พยากรณ์ได้") และ [Smart Integrations spec § ข้อสมมติฐาน/การตัดสินใจที่ยืนยันแล้ว](01-spec/20260823-04-smart-integrations.md#ข้อสมมติฐานการตัดสินใจที่ยืนยันแล้ว)

> หมายเหตุ: AC-INT-1-08/09 เป็น boundary scenario ของเกณฑ์ขั้นต่ำ 7 วันที่ resolve แล้วเมื่อ 2026-09-26 —
> มาจาก Alt/Edge Case ที่ `user-journeys.md` ระบุไว้ตรง ("น้อยกว่า 7 วัน → empty state; ครบ 7 วันพอดี →
> พยากรณ์ได้") ไม่ใช่ edge case ใหม่ที่คิดขึ้นเอง — ตรงกับโค้ดจริง `apps/web/server/domain/weightForecast.ts`
> (`MIN_LOG_DAYS_FOR_FORECAST = 7`, เงื่อนไข `length < MIN_LOG_DAYS_FOR_FORECAST` → insufficient)
...
|---|---|
| ONB-0 | 10 (เพิ่ม AC-ONB-0-08 ถึง 10 เมื่อ 2026-09-26) |
| ONB-1 | 3 |
| ONB-2 | 3 |
...
| INT-1 | 9 (เพิ่ม AC-INT-1-08/09 boundary 6/7 วัน เมื่อ 2026-09-26) |
| INT-2 | 2 |
...
>
> อัปเดต 2026-09-26 (`test-suite-builder`, ขอบเขต INT-1 เท่านั้น): Smart Integrations spec resolve จำนวนวัน
> log ขั้นต่ำก่อนพยากรณ์ของ INT-1/REQ-11 = **7 วัน** (เดิมเป็น "จุดที่ยังไม่ได้ระบุ") — ปรับ AC-INT-1-01/02 ให้
> ระบุ 7 วันตรง ๆ และเพิ่ม **AC-INT-1-08** (6 วัน → empty state) และ **AC-INT-1-09** (7 วันพอดี → พยากรณ์ได้)
> จาก Alt/Edge Case ของ `user-journeys.md` § INT-1 — INT-1 จาก 7 เป็น **9** scenario รวม scenario จาก 72 เป็น
> **74** (Feature ID ยังคง 16 ตัวเท่าเดิม)
>
> อัปเดต 2026-09-26 (`test-suite-builder`, ขอบเขต ONB-0 เท่านั้น): Onboarding spec เพิ่ม decision "เข้าสู่ระบบ
> ไม่สำเร็จ (REQ-15)" และ `user-journeys.md` § ONB-0 เพิ่มทางแยก "ไม่สำเร็จ" (Step 10 + Alt/Edge Case) — เพิ่ม
> **AC-ONB-0-08** (credential ผิด ข้อความเดียวกันทั้งรหัสผ่านผิดและอีเมลที่ไม่มีบัญชี), **AC-ONB-0-09**
> (ช่องว่าง ตรวจก่อนส่ง), **AC-ONB-0-10** (สาเหตุอื่น ข้อความภาษาไทย ไม่มีข้อความทางเทคนิคดิบ) — ONB-0 จาก 7
> เป็น **10** scenario รวม scenario จาก 74 เป็น **77** (Feature ID ยังคง 16 ตัวเท่าเดิม) — AC เดิมไม่มีข้อไหน
> อ้างเลข Step ของ journey จึงไม่กระทบจากการเลื่อน Step เดิม 10–11 เป็น 11–12
