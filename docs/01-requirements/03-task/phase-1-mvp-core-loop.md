...
- **อัปเดตล่าสุด:** 2026-09-26 — อัปเดต **Status ตามการยืนยันของผู้ใช้**: `TASK-INFRA-01` = เสร็จแล้ว
  (มี Firebase project จริงและ deploy Express บน Cloud Run + Firebase Hosting แล้ว — commit `65ec39a`,
  `15bdcf7`), task ของ Feature ID ทั้งหมดในไฟล์นี้ = กำลังทำ (มีโค้ดจริงแล้ว แต่ยังไม่ผ่าน Exit Criteria ของ
  [Release Plan §3.1](../02-plan/release-plan.md#31-mvp-phase) — test case ยัง execute ไม่ครบ มีเพียง unit test
  ของ domain logic ตาม [test-results.md](../../03-testing/02-test-result/test-results.md)) — แก้คำอธิบาย
  `TASK-INFRA-01` ให้ตรงกับ stack ปัจจุบัน (Express.js บน Cloud Run แทน Cloud Functions) และ `TASK-ONB-3`
  ให้ตรงกับโมเดลเป้าหมาย 2 ค่าของ REQ-02 (เป้าเผาผลาญ + เป้าการกินที่มี safety floor)
- **อัปเดตก่อนหน้า:** 2026-08-31 — แก้คำอธิบาย `TASK-REC-1` ให้ตรงกับ implementation จริง: ตัดส่วน "ขยายเกณฑ์
...
| TASK-ONB-3 | ตั้งเป้าหมายหลัก (deficit/surplus + safety floor) | ONB-3 / REQ-02 | กำลังทำ | เลือกประเภทเป้าหมาย แล้วคำนวณ 2 ค่า: เป้าเผาผลาญรายวัน (`dailyCalorieTargetKcal` = น้ำหนัก × ค่าคงที่ต่อเป้าหมาย ไม่มี floor) และเป้าการกินรายวัน (`dailyIntakeTargetKcal` = TDEE ± ค่าคงที่ต่อเป้าหมาย มี safety floor 1,200 kcal) | AC-ONB-3-01–03, [detailed-design/01-onboarding-personalization.md](../../02-design/02-technical/detailed-design/01-onboarding-personalization.md) |
| TASK-REC-1 | แนะนำวิดีโอตรงเป้าแคลอรี่รายวัน | REC-1 / REQ-04 | กำลังทำ | จับคู่วิดีโอตามเป้าหมายแคลอรี่ + filter อุปกรณ์ (ค้นหาครั้งเดียว ให้ขั้นตอน AI ประเมิน/เลือกวิดีโอที่ดีที่สุดจากที่พบ ไม่มีการขยายเกณฑ์ค้นหาซ้ำ) | AC-REC-1-01–03, [detailed-design/02-daily-youtube-recommendation.md](../../02-design/02-technical/detailed-design/02-daily-youtube-recommendation.md) |
| TASK-REC-2 | คำนวณแคลอรี่เผาผลาญจริง (สูตร MET) | REC-2 / REQ-05 | กำลังทำ | คำนวณ kcal = MET × น้ำหนักตัว × เวลาจริง หลังจบ/หยุดเซสชัน | AC-REC-2-01–03, [detailed-design/02-daily-youtube-recommendation.md](../../02-design/02-technical/detailed-design/02-daily-youtube-recommendation.md) |
| TASK-PLN-1 | ปฏิทินวางแผนรายสัปดาห์ | PLN-1 / REQ-08 | กำลังทำ | ปฏิทิน fixed calendar week (จ.-อา.) กำหนดกิจกรรมล่วงหน้า วันในอดีตที่มี log เป็น read-only | AC-PLN-1-01–03, [detailed-design/03-planner-logging.md](../../02-design/02-technical/detailed-design/03-planner-logging.md) |
| TASK-PLN-2 | โหมด Cheat Day / Rest Day | PLN-2 / REQ-09 | กำลังทำ | ตั้ง Cheat/Rest Day มาร์ก "ครบเป้าหมาย" — ทับ log เดิมได้เฉพาะวันนี้เท่านั้น | AC-PLN-2-01–04, [detailed-design/03-planner-logging.md](../../02-design/02-technical/detailed-design/03-planner-logging.md) |
| TASK-PLN-3 | บันทึกผลรายวัน (all-or-nothing) | PLN-3 / REQ-10 | กำลังทำ | เทียบแคลอรี่ที่เผาผลาญจริงกับเป้าหมาย ≥100% เท่านั้นถือว่าครบ ไม่มี partial credit | AC-PLN-3-01–03, [detailed-design/03-planner-logging.md](../../02-design/02-technical/detailed-design/03-planner-logging.md) |
