...
- **อัปเดตล่าสุด (sync เลข Step กับ `user-journeys.md` ฉบับ 7-step):** 2026-08-31 — follow-up fix ต่อจาก
